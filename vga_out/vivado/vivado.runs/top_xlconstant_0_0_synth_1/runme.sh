...
HD_PWD='/home/ashley/Verilog/vga_out/vivado/vivado.runs/top_xlconstant_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_xlconstant_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_xlconstant_0_0.tcl
